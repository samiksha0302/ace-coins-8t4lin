...
class CoinBuy extends React.Component<Props, State> {
    ...
    buy = () => {
        ...
        .then((result) => {
            ...
            this.setState({toastMessage: this.state.amount+' Coins Bought', toastState: true});   
        },
        ...
        return (
            <>
                ...
                <IonGrid className="ion-justify-content-center ion-align-items-center ion-align-self-center">
                    ...
                    <IonRow className='ion-padding'>
                        <IonCol>
                            <IonItem>
                                ...
                                <IonInput  onIonChange={this.updateAmount} type="number" placeholder="Enter Coins to Buy"></IonInput>
                            </IonItem>
                        </IonCol>
                    </IonRow>
                    ...
                    <IonRow className='ion-padding'>
                        <IonCol>
                                <IonButton expand="block" onClick={this.buy}>Buy</IonButton>
                        </IonCol>
                    </IonRow>
                </IonGrid>
